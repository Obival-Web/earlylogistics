...
export default function Home() {
  ...
  return (
    <main className="h-screen bg-img-mobile bg-img-desktop">
      <div className="h-full bg-black/60 flex flex-col justify-between py-8 md:py-10 lg:py-12 px-6 md:px-12 
      lg:px-72">
         <p className={`${abril.className} text-white text-3xl text-center`}>Early
           Logistics</p>

         <div className="flex flex-col gap-5">
          <h1 className="text-yellow-500 text-5xl lg:text-6xl font-bold text-center">Package Tracking At It&apos;s 
            Best</h1>
          ...
          <footer className="flex flex-col gap-6">
            <ul className="flex justify-center items-center gap-8">
              ...
              <li className="text-white text-2xl">
                <Link href="https://x.com/earlycodetech"><FaTwitter/></Link>
              </li>
            </ul>
