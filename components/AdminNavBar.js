...
export default function AdminNav () {
    return (
        <nav className="h-[60px] fixed top-0 right-0 left-0 z-10 flex flex-row justify-between
         items-center bg-red-700 px-4 md:px-8 ">
            <ul className="flex flex-row items-center gap-6">
                <li className="py-1 hover:border-b-2 hover:boder-white">
